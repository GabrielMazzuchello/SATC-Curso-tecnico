...
class Mamifero extends Animal {
    ...
    public Mamifero(String nome, float comprimento, String cor, String ambiente, float velocidadeMedia, String alimento) {
        super(nome, comprimento, 4, cor, ambiente, velocidadeMedia); // Mamíferos têm 4 patas por padrão
...
class Ave extends Animal {
    ...
    public Ave(String nome, float comprimento, String cor, String ambiente, float velocidadeMedia, String raca) {
        super(nome, comprimento, 4, cor, ambiente, velocidadeMedia); // Mamíferos têm 4 patas por padrão
        this.raca = raca;
    }
    ...
    public void setAlimento(String raca) {
        this.raca = raca;
    }
...
public class ex03 {
    public static void main(String[] args) {
        ...
        if (escolha == 1) {
            ...
            System.out.print("Alimento (carnívoro, herbívoro, onívoro): ");
            String alimento = scanner.nextLine();

            Mamifero mamifero = new Mamifero(nome, comprimento, cor, ambiente, velocidade, alimento);
            mamifero.dados(); 
        } else if (escolha == 4) {
            System.out.print("Raça: ");
            String raca = scanner.nextLine();

            Mamifero mamifero = new Mamifero(nome, comprimento, cor, ambiente, velocidade, raca);
            mamifero.dados();
        } else {
